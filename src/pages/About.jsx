  ...
  return(
      ...
      <>
          ...
          <div className="  text-justify flex p-5">
            ...
            <div className=" shadow-xl text-white " > 
          <h1 className=" text-5xl mt-[7vh] underline hover:underline-offset-8 justify-center text-center font-serif ">DEPARTMENT</h1> 
          
          <div className="mt-3  text-justify flex p-5">
              
              <div className=" pt-0 px-6">
              <p className= " font-semibold shadow-lg shadow-red-500 md:shadow-xl    text-clip overflow-hidden ... justify-center font-sans " >About the Department: The Electronics and Communication Engineering was one of the branches started under the aegis of University College of Engineering, established in the year 2003, at Punjabi University, Patiala (Main Campus). The branch had made a modest beginning with a single under-graduate course of four-year duration, viz., Bachelor of Technology (B.Tech.) in Electronics and Communication Engineering. All the courses of the Department are approved by AICTE.Initially University’s jurisdiction area was fixed as the 16 km radius having only 9 colleges. In 1969, it grew into an affiliating university, with 43 colleges affiliated to it. Now the university caters to the educational needs of nine Districts of Punjab. Over the time since its inception, the University has evolved into a multi-faceted and multi-faculty educational institution for the promotion of higher education and research in Humanities, Arts, Sciences, Engineering Languages, Technology and many more. Spread over 600 acres of land, its 1500+ teachers are imparting instruction and guidance to nearly 14,000+ students in a multi-faceted, multi-pronged and multi-faculty environment comprising 70+ Teaching and Research Departments/Chairs on its Campus, 27 Regional Centre/ Neighbourhood Campuses/Constituent Colleges and 274 Colleges affiliated to it. </p>
              </div>
              <div className=" w-[1000vw] h-[30vh] "><img src="https://images.static-collegedunia.com/public/college_data/images/campusimage/1410348081uce6.jpg"className=" rounded"alt="ucoe"/></div>
