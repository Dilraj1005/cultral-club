 ...
 function About(){
    ...
    return(
        ...
        <div className="">
            ...
            <h1 className=" text-5xl mt-4 underline hover:underline-offset-8 justify-center text-center font-serif ">ABOUT PUNJABI UNIVERSITY ,PATIALA</h1>
            ...
            <div className="p-20 shadow-xl">
                <h1 className=" text-5xl underline hover:underline-offset-8  justify-center text-center font-serif ">ABOUT ELECTRONIC AND COMMUNICATION DEPARTMENT</h1>
                <div>
                    <h3 className=" text-4xl pt-10 underline hover:underline-offset-8  justify-center text-center font-serif ">ABOUT THE DEPARTMENT</h3>

                    <div className="text-justify flex m-20">
                        {/* <div><img src="https://images.static-collegedunia.com/public/college_data/images/campusimage/1410348081uce6.jpg"className=" rounded"alt="ucoe"/></div> */}
        ...
        <div  className="p-20 shadow-xl">
            ...
            <h1 className=" text-5xl underline hover:underline-offset-8 justify-center text-center font-serif ">ABOUT CULTURAL CLUB</h1>
            <div className="text-justify flex m-20 ">
                <div className="w-[84%]"><img src="https://images.northernstage.co.uk/uploads/2023/10/1.png" alt="cultural-club" className="rounded"/></div>
...
They provide a platform for students to come together and share their experiences and perspectives, fostering a sense of community and understanding. Let’s take a look at all the benefits of diverse college clubs and specific opportunities for you to get involved.</p>
        ...
        {/* <div>
            <h1 className="pt-10 underline hover:underline-offset-8  justify-center text-center font-serif text-xl">ABOUT THE FACULTY </h1>
